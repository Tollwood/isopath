...
namespace Application
{
    ...
    public class MoveStoneTest
    {
        ...
        public void canMoveAnyWhere_initial()
        {
            ...
            Assert.False(Rules.canMoveStoneAnyWhere(board.tiles,board.currentPlayer));
        }
        ...
        public void canDiggerMoveAnyWhere_movable()
        {
            ...
            Assert.True(Rules.canMoveStoneAnyWhere(board.tiles,board.currentPlayer));
        }

        [Test()]
        public void canClimberMoveAnyWhere_movable()
        {
            Board board = new Board(4, BoardStateModifier.ResetTiles(4), Step.BUILD, Player.CLIMBER);
